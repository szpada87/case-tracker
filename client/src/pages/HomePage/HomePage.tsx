            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
                    ...
                    <div className="mt-4 md:mt-0">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Nunc mi turpis, dapibus vitae lacus et, bibendum faucibus nisl. Donec maximus bibendum tortor, et auctor nunc sagittis et. Nam tempus felis et iaculis sollicitudin.</h2>
